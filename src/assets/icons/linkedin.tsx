...
/**
 * renders the LinkedInIcon component.
 * @param {IconType} props the LinkedInIcon component props.
 * @returns {JSX.Element} the LinkedInIcon component.
 */
const LinkedInIcon: FC<IconType> = ({ size = 24 }: IconType): JSX.Element => {
  return (
    <svg
